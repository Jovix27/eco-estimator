        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-bold tracking-tight leading-[0.9]">
              ...
              <span className="italic text-[var(--nothing-lime)]">SUSTAINABLE</span>
            </h1>
          ...
          >
            ...
            <div className="relative glass border-[var(--nothing-border-strong)] p-2 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                ...
                <div className="glass px-4 py-2 text-[9px] font-mono tracking-widest text-[var(--nothing-lime)] uppercase">
                  ACTIVE_LINK
                </div>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-6 border-y border-[var(--nothing-border)] py-12 flex flex-wrap justify-between gap-12">
        {[
          ...
          <div key={i} className="space-y-1">
            ...
            <p className="text-2xl font-bold italic tracking-tighter uppercase">{s.val}</p>
          </div>
        ))}
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-1 bg-[var(--nothing-border)]">
          {features.map((f, i) => (
            <motion.div
              ...
              className="p-8 bg-[var(--nothing-bg)] group transition-all relative"
            >
              <div className="flex justify-between items-start mb-12">
                <div className="w-10 h-10 flex items-center justify-center border border-[var(--nothing-border-strong)] text-[var(--nothing-lime)] group-hover:bg-[var(--nothing-lime)] group-hover:text-black transition-all">
                  {f.icon}
                </div>
                <span className="text-[8px] font-mono text-[var(--nothing-text-dim)] tracking-widest uppercase">{f.tag}</span>
              </div>
              <h3 className="text-xl font-bold mb-3 tracking-tight italic uppercase group-hover:text-[var(--nothing-lime)] transition-colors">{f.title}</h3>
